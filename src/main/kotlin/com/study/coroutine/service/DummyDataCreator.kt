...
//
//import com.study.coroutine.service.Articles.authorId
//import com.study.coroutine.service.Articles.body
//import com.study.coroutine.service.Articles.createdAt
//import com.study.coroutine.service.Articles.title
//import com.study.coroutine.service.Articles.updatedAt
...
//    transaction {
//        Articles.deleteAll()
//        (1L..dataSize).windowed(size = bufferSize, step = bufferSize, partialWindows = true)
//            .forEachIndexed { index, nums ->
...
//    Database.connect(
//        url = "jdbc:mariadb://localhost:3308/sample?rewriteBatchedStatements = true",
